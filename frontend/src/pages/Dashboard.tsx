  ...
  return (
    <main className="bg-auplant-cream">
      <PageHero
        ...
        description="Manage your profile, sitter information and care requests."
      />
      <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          {sitterProfile ? (
            ...
            <section className="flex flex-col justify-center rounded-2xl border border-dashed border-auplant-sage bg-auplant-cream p-6">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Create a sitter profile and help other plant owners while
                they're away.
              </p>
        ...
        <section className="mt-8 rounded-2xl border border-red-200 bg-red-50 p-6">
          ...
          <p className="mt-2 max-w-2xl text-sm text-gray-700">
            Permanently delete your AuPlant account, sitter profile, care
            requests and uploaded images. This action cannot be undone.
          </p>
